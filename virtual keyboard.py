...
while True:
    ...
    showKey.drawKey(frame,(255,255,0), (0,0,0),0.1, fontScale=0.5)
    exitKey.drawKey(frame,(255,0,255), (0,0,0),0.1, fontScale=0.5)
    ...
    alpha = 0.5
    if show:
        textBox.drawKey(frame, (255,255,72), (56,0,72), 0.3)
        for k in keys:
            ...
            k.drawKey(frame,(0,72,255), (0,72,0), alpha=alpha)
            alpha = 0.5
        clickedX, clickedY = 0, 0        
    ptime = ctime
